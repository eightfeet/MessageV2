 ...
 * @returns
 */
export declare function createDom(dom: string, target: string, parentId: string, emBase: number, msgRoot: HTMLElement, directionFrom: 'top' | 'bottom'): Promise<HTMLElement>;
/**
 * 移除指定id的dom及其子节点
 *
 * @export
